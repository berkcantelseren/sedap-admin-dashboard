  ...
  return (
    <div className="w-[75%] fixed ml-[65px] bg-white justify-items-center h-24 hidden lg:block">
      ...
      <div className="justify-center items-center flex w-[250px] ml-250 mt-[-50] h-15">
        {/* right line  */}
        <div className="absolute right-[-110px] h-[60px] w-[2px] bg-gray-300"></div>
      ...
      {/* profile section */}
      <div className="justify-start items-center flex w-[180px] ml-390 mt-[-60] h-15 text-start">
        <div className="ml-3">
          <p>
            <span className="text-sm text-gray-600 mr-1">Hello,</span>
