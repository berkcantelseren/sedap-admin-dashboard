...
export default function Navbar() {
  return (
    <div className="w-[90%] fixed justify-items-center h-24">
      <div>
        <input
          type="text"
          placeholder="Search here"
          className="w-[41rem] h-[2.5rem] rounded-lg text-gray-500 align-center justify-center flex ml-20 mt-10 text-left p-5 border border-gray-200 outline-0"
        />
